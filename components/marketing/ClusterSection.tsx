...
const clusters = [
  {
    ...
    body: "Chanderi is famous for feather-light sarees woven from a fine silk and cotton blend, prized for their sheer, glossy texture. LoomMitra can be piloted with a Chanderi cooperative: each saree leaves the loom with a QR-based passport, so its origin travels with it to any market.",
  },
  {
